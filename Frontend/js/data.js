window.GUNPLA_DATA = {
  products: [
    { id: "kit-aerial", name: "HG Gundam Aerial Rebuild", grade: "HG", skill: "Beginner", price: 980, stock: 16, status: "Available", storeId: "baguio-station", image: "../images/modal3.png", tags: ["First build", "Snap-fit"], description: "A beginner-friendly kit with clean color separation, stable articulation, and low tool requirements." },
    { id: "kit-nu", name: "RG Nu Gundam", grade: "RG", skill: "Intermediate", price: 2250, stock: 5, status: "Available", storeId: "runner-gate", image: "../images/modal1.png", tags: ["Detailed", "Popular"], description: "A detailed real-grade kit for builders who want more panel lines, decals, and articulation." },
    { id: "kit-barbatos", name: "MG Barbatos", grade: "MG", skill: "Advanced", price: 3200, stock: 0, status: "Pre-order", storeId: "baguio-station", image: "../images/modal2.png", tags: ["Inner frame", "Pre-order"], description: "A master-grade build with a visible inner frame and strong display value." },
    { id: "kit-calibarn", name: "HG Calibarn", grade: "HG", skill: "Beginner", price: 1180, stock: 8, status: "Available", storeId: "mecha-corner", image: "../images/modal3.png", tags: ["Beginner", "Hot"], description: "A stylish high-grade kit with strong shelf presence and beginner-safe assembly." },
    { id: "kit-wing", name: "MG Wing Zero EW", grade: "MG", skill: "Advanced", price: 3900, stock: 0, status: "Restock Soon", storeId: "north-build", image: "../images/modal1.png", tags: ["Display", "Restock"], description: "A dramatic display kit for experienced builders looking for a centerpiece model." },
    { id: "kit-rx78", name: "Entry Grade RX-78-2", grade: "EG", skill: "Beginner", price: 550, stock: 20, status: "Available", storeId: "mecha-corner", image: "../images/modal2.png", tags: ["Budget", "First kit"], description: "A low-cost entry kit made for first-time builders and quick weekend builds." }
  ],
  stores: [
